...
var _userTransformer = function(ctx, activityEntities, callback) {
    ...
    // Transform the user entities
    var userInfos = _.map(entityInfo, function(info) {
        return {
            'userId': info.entityId,
            'user': info.entity
        };
    });
    PrincipalsUtil.transformPersistentUserActivityEntities(ctx, userInfos, function(err, transformedEntities) {
        if (err) {
            return callback(err);
        }
...
var _userInternalTransformer = function(ctx, activityEntities, callback) {
    ...
    PrincipalsUtil.transformPersistentUserActivityEntityToInternal(ctx, _.pluck(entityInfo, 'entity'), function(err, transformedEntities) {
        if (err) {
            return callback(err);
        }
...
var _groupTransformer = function(ctx, activityEntities, callback) {
    ...
    PrincipalsUtil.transformPersistentGroupActivityEntities(ctx, _.pluck(entityInfo, 'entity'), function(err, transformedEntities) {
        if (err) {
            return callback(err);
        }
...
var _groupInternalTransformer = function(ctx, activityEntities, callback) {
    ...
    PrincipalsUtil.transformPersistentGroupActivityEntitiesToInternal(ctx, _.pluck(entityInfo, 'entity'), function(err, transformedEntities) {
        if (err) {
            return callback(err);
        }
