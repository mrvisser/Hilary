...
var _transformUserDocuments = function(ctx, docs, callback, _transformedDocs) {
    ...
    // Sign the thumbnail urls
    var signedProperties = {'thumbnailUrl': 'thumbnailUrl'};
    ContentUtil.signObjectUrlProperties(ctx, _.values(transformedDocs), signedProperties, null, function(err) {
        if (err) {
            return callback(err);
        }
