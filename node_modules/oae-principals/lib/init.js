...
module.exports = function(config, callback) {
    ...
    ensureSchema(function(err) {
        ...
        ensureSearchSchema(function(err) {
            if (err) {
                return callback(err);
            }
...
/**
 * Create the memberships search schema if it hasn't already been created
 *
...
var ensureSearchSchema = function(callback) {
    var membershipsSchema = require('./schemas/memberships');

    // The memberships type will be a child of the resource type
    var childOpts = {
        '_source': false,
        '_parent': SearchConstants.resourceMappingName
    };

    SearchAPI.putMapping(PrincipalsConstants.search.resourceMembershipsMappingName, membershipsSchema, childOpts, callback);
};
