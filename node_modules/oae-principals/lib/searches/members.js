...
var _search = function(ctx, opts, callback) {
    ...
    var filter = SearchUtil.filterAnd(
        ...
        // Since we're searching through a group's list of members, we need to get those
        // principals who have this group in their "memberships" document
        SearchUtil.createHasChildQuery(PrincipalsConstants.search.resourceMembershipsMappingName, SearchUtil.filterTerms('direct_memberships', [opts.resourceId]))
    );
