...
/**
 * Search through a principal's memberships.
 *
...
/**
 * Perform the search that searches through the list of groups a principal is a member of
 *
 * @param  {Context}       ctx                 The context of the current request
 * @param  {Object}        opts                General search options
 * @param  {Function}      callback            Invoked when the process completes
...
var _search = function(ctx, opts, callback) {
    ...
    // Unlike other searches we cannot simply query ES here as we only index the direct members of a group.
    // Therefor we need to retrieve the full ancestry of the principal from Cassandra. Once we have the IDs
    // of the groups were a member of, we simply pass them to ES and ask for those groups.
