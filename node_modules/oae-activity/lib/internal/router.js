...
var routeActivity = module.exports.routeActivity = function(activitySeed, callback) {
    ...
    _produceAllEntities(activitySeed, function(err, actor, object, target) {
        ...
        _produceAllRoutes(activitySeed, actor, object, target, function(err, routes) {
            ...
            // A hash that maps {resourceId -> streamType -> activity} for each activity that will be delivered to
            ...
            _.each(routes, function(route) {
                ...
                if (!route.transient) {
                    allDeliveredActivities[route.resourceId] = allDeliveredActivities[route.resourceId] || {};
                    allDeliveredActivities[route.resourceId][route.streamtype] = activity;
                }
            });
            ...
            ActivityEmitter.emit(ActivityConstants.events.ROUTED_ACTIVITIES, activitySeed, allRoutedActivities);
            ...
            _queueActivities(activitySeed, allDeliveredActivities, function(err, buckets) {
                ...
                // Count the number of routed activities by getting the number of activity children in the
                // delivered activities map
                var numRouted = _.reduce(allDeliveredActivities, function(memo, streamTypeActivity) {
                    return (memo + _.values(streamTypeActivity).length);
                });

                // How many routed activities are created and how long it took
                Telemetry.incr('routed.count', numRouted);
