                ...
                ActivityDAO.getAggregatedEntities(_.keys(activeAggregates), function(err, fetchedEntities) {
                    ...
                    ActivityDAO.saveAggregatedEntities(allAggregates, function(err) {
                        ...
                        _.keys(aggregatesToDeliver).forEach(function(aggregateKey) {
                            ...
                            if (actor && actor[ActivityConstants.properties.OAE_COLLECTION] && _.contains(actor[ActivityConstants.properties.OAE_COLLECTION], null)) {
                                log().warn({'route': aggregate.route, 'actor': actor}, 'Actor had null items in collection');
                            }

                            if (object && object[ActivityConstants.properties.OAE_COLLECTION] && _.contains(object[ActivityConstants.properties.OAE_COLLECTION], null)) {
                                log().warn({'route': aggregate.route, 'object': object}, 'Object had null items in collection');
                            }

                            if (target && target[ActivityConstants.properties.OAE_COLLECTION] && _.contains(target[ActivityConstants.properties.OAE_COLLECTION], null)) {
                                log().warn({'route': aggregate.route, 'target': target}, 'Target had null items in collection');
                            }
