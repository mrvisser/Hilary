...
var ensureSchema = function(callback) {
    Cassandra.createColumnFamilies({
        ...
        'ActivityAggregationStatus': 'CREATE COLUMNFAMILY ActivityAggregationStatus (aggregateKey text PRIMARY KEY, lastUpdate text, lastAggregateKey text);',
        'ActivityAggregation': 'CREATE COLUMNFAMILY ActivityAggregation (aggregateKey text PRIMARY KEY);'
    }, callback);
};
