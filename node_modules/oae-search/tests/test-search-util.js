...
describe('Search Util', function() {
    ...
    describe('#getScopeParam', function() {

        /**
         * Test that verifies valid and invalid values for SearchUtil.getScopeParam
         */
        it('verify getScopeParam', function(callback) {
            assert.strictEqual('_all', SearchUtil.getScopeParam());
            assert.strictEqual('_all', SearchUtil.getScopeParam(''));
            assert.strictEqual('_all', SearchUtil.getScopeParam('', ''));
            assert.strictEqual('_all', SearchUtil.getScopeParam(null, ''));
            assert.strictEqual('_all', SearchUtil.getScopeParam(undefined, ''));
            assert.strictEqual('_all', SearchUtil.getScopeParam('_all'));
            assert.strictEqual('test', SearchUtil.getScopeParam(undefined, 'test'));
            assert.strictEqual('test', SearchUtil.getScopeParam('test'));
            return callback();
        });
    });
});
