                                                    ...
                                                    SearchTestsUtil.searchRefreshed(camAdminRestContext, 'general', null, {'q': uniqueString}, function(err, results) {
                                                        ...
                                                        SearchTestsUtil.searchRefreshed(janeRestContext, 'general', null, {'q': uniqueString}, function(err, results) {
                                                            ...
                                                            SearchTestsUtil.searchRefreshed(jackRestContext, 'general', null, {'q': uniqueString}, function(err, results) {
                                                                ...
                                                                // Verify global admin can see it from cam tenant
                                                                RestAPI.Admin.loginOnTenant(globalAdminRestContext, global.oaeTests.tenants.localhost.alias, function(err, globalAdminRestContext) {
                                                                    assert.ok(!err, JSON.stringify(err, null, 4));

                                                                    // Verify global admin from different tenant can see it
                                                                    SearchTestsUtil.searchRefreshed(globalAdminRestContext, 'general', null, {'q': uniqueString}, function(err, results) {
                                                                        assert.ok(!err);
