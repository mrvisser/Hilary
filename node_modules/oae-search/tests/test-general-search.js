...
describe('General Search', function() {
    ...
    var searchForResource = function(restCtx, resource, expectInResults, callback) {
        SearchTestsUtil.searchRefreshed(restCtx, 'general', null, {'scope': '_all', 'resourceTypes': resource.resourceType, 'q': resource.displayName}, function(err, results) {
            assert.ok(!err);
                ...
                RestAPI.Content.createLink(camUser.restContext, 'OAE Project', null, 'public', 'http://www.oaeproject.org', [], [], function(err, camContentObj) {
                    ...
                    TestsUtil.generateTestUsers(gtAdminRestContext, 1, function(err, gtUsers, gtUser) {
                        ...
                        RestAPI.Content.createLink(gtUser.restContext, 'Google', null, 'public', 'http://www.google.com', [], [], function(err, gtContentObj) {
                            ...
                            SearchTestsUtil.searchAll(globalAdminRestContext, 'general', null, {'q': 'oaeproject', 'scope': '_all'}, function(err, results) {
                                assert.ok(!err);
                                ...
                                SearchTestsUtil.searchAll(globalAdminRestContext, 'general', null, {'q': 'google', 'scope': '_all'}, function(err, results) {
                                    assert.ok(!err);
                                                    ...
                                                    ConfigTestUtil.updateConfigAndWait(globalAdminRestContext, camContentObj.tenantAlias, {'oae-tenants/tenantprivacy/tenantprivate': true}, function(err) {
                                                        ...
                                                        SearchTestsUtil.searchAll(globalAdminRestContext, 'general', null, {'q': 'oaeproject', 'scope': '_all'}, function(err, results) {
                                                            ...
                                                            SearchTestsUtil.searchAll(globalAdminRestContext, 'general', null, {'q': 'oaeproject'}, function(err, results) {
                                                                ...
                                                                SearchTestsUtil.searchAll(camAdminRestContext, 'general', null, {'q': 'oaeproject', 'scope': '_all'}, function(err, results) {
                                                                    assert.ok(!err);
                                                                    assert.ok(_getDocById(results, camContentObj.id));
                                                                    ...
                                                                    SearchTestsUtil.searchAll(camAdminRestContext, 'general', null, {'q': 'oaeproject'}, function(err, results) {
                                                                        ...
                                                                        SearchTestsUtil.searchAll(camAdminRestContext, 'general', null, {'q': 'google', 'scope': '_all'}, function(err, results) {
                                                                            assert.ok(!err);
                                                                            assert.ok(!_getDocById(results, gtContentObj.id));
                                                                            ...
                                                                            SearchTestsUtil.searchAll(camAdminRestContext, 'general', null, {'q': 'google'}, function(err, results) {
                                                                                ...
                                                                                SearchTestsUtil.searchAll(gtAdminRestContext, 'general', null, {'q': 'oaeproject', 'scope': '_all'}, function(err, results) {
                                                                                    assert.ok(!err);
                                                                                    assert.ok(!_getDocById(results, camContentObj.id));
                                                                                    ...
                                                                                    SearchTestsUtil.searchAll(gtAdminRestContext, 'general', null, {'q': 'oaeproject'}, function(err, results) {
                                                                                        ...
                                                                                        SearchTestsUtil.searchAll(camUser.restContext, 'general', null, {'q': 'oaeproject', 'scope': '_all'}, function(err, results) {
                                                                                            assert.ok(!err);
                                                                                            assert.ok(_getDocById(results, camContentObj.id));
                                                                                            ...
                                                                                            SearchTestsUtil.searchAll(camUser.restContext, 'general', null, {'q': 'oaeproject'}, function(err, results) {
                                                                                                ...
                                                                                                SearchTestsUtil.searchAll(gtUser.restContext, 'general', null, {'q': 'oaeproject', 'scope': '_all'}, function(err, results) {
                                                                                                    assert.ok(!err);
                                                                                                    assert.ok(!_getDocById(results, camContentObj.id));
                                    ...
                                    TestsUtil.generateGroupHierarchy(doerRestContext, [groupIds[4], jack.id], 'member', function(err) {
                                        ...
                                        RestAPI.Content.createLink(doerRestContext, uniqueString, 'Test content description 1', 'loggedin', 'http://www.oaeproject.org/',  [], [groupIds[0]], function(err, contentObj) {
                                            ...
                                            SearchTestsUtil.searchRefreshed(anonymousRestContext, 'general', null, {'q': uniqueString}, function(err, results) {
                                                ...
                                                SearchTestsUtil.searchRefreshed(darthVaderRestContext, 'general', null, {'q': uniqueString, 'scope': '_all'}, function(err, results) {
                                                    assert.ok(!err);
                                                    assert.ok(!_getDocById(results, contentObj.id));
                                                    ...
                                                    SearchTestsUtil.searchRefreshed(camAdminRestContext, 'general', null, {'q': uniqueString}, function(err, results) {
                                                        ...
                                                        SearchTestsUtil.searchRefreshed(janeRestContext, 'general', null, {'q': uniqueString}, function(err, results) {
                                                            ...
                                                            SearchTestsUtil.searchRefreshed(jackRestContext, 'general', null, {'q': uniqueString}, function(err, results) {
                                                                ...
                                                                SearchTestsUtil.searchRefreshed(globalAdminOnTenantRestContext, 'general', null, {'q': uniqueString, 'scope': '_all'}, function(err, results) {
                                                                    assert.ok(!err);
            ...
            RestAPI.User.createUser(gtAdminRestContext, darthVaderUsername, 'password', 'Darth Vader', null, function(err, darthVader) {
                ...
                RestAPI.User.createUser(camAdminRestContext, jackUsername, 'password', uniqueString, jackOpts, function(err, jack) {
                    ...
                    RestAPI.User.createUser(camAdminRestContext, janeUsername, 'password', 'Janey McJaneFace', null, function(err, jane) {
                        ...
                        SearchTestsUtil.searchAll(darthVaderRestContext, 'general', null, {'resourceTypes': 'user', 'q': uniqueString}, function(err, results) {
                            assert.ok(!err);
                            var jackDoc = _getDocById(results, jack.id);
                            assert.ok(!jackDoc);

                            // Verify visible for cross-tenant user on external search
                            SearchTestsUtil.searchAll(darthVaderRestContext, 'general', null, {'resourceTypes': 'user', 'q': uniqueString, 'scope': '_all'}, function(err, results) {
                                assert.ok(!err);
                                var jackDoc = _getDocById(results, jack.id);
                                assert.ok(jackDoc);
                                ...
                                SearchTestsUtil.searchAll(anonymousRestContext, 'general', null, {'resourceTypes': 'user', 'q': uniqueString}, function(err, results) {
                                    assert.ok(!err);
                                    var jackDoc = _getDocById(results, jack.id);
                                    assert.ok(jackDoc);
                                    assert.equal(jackDoc.id, jack.id);
                                    ...
                                    SearchTestsUtil.searchAll(janeRestContext, 'general', null, {'resourceTypes': 'user', 'q': uniqueString}, function(err, results) {
                                        assert.ok(!err);
                                        var jackDoc = _getDocById(results, jack.id);
                                        assert.ok(jackDoc);
                                        assert.equal(jackDoc.id, jack.id);
                                        ...
                                        SearchTestsUtil.searchAll(camAdminRestContext, 'general', null, {'resourceTypes': 'user', 'q': uniqueString}, function(err, results) {
                                            assert.ok(!err);
                                            var jackDoc = _getDocById(results, jack.id);
                                            assert.ok(jackDoc);
                                            assert.equal(jackDoc.id, jack.id);
                ...
                RestAPI.User.createUser(camAdminRestContext, jackUsername, 'password', uniqueString, jackOpts, function(err, jack) {
                    ...
                    RestAPI.User.createUser(camAdminRestContext, janeUsername, 'password', 'Janey McJaneFace', null, function(err, jane) {
                        ...
                        SearchTestsUtil.searchRefreshed(darthVaderRestContext, 'general', null, {'resourceTypes': 'user', 'q': uniqueString}, function(err, results) {
                            ...
                            SearchTestsUtil.searchRefreshed(darthVaderRestContext, 'general', null, {'resourceTypes': 'user', 'q': uniqueString, 'scope': '_all'}, function(err, results) {
                                assert.ok(!err);
                                var jackDoc = _getDocById(results, jack.id);
                                assert.ok(!jackDoc);
                                ...
                                SearchTestsUtil.searchRefreshed(anonymousRestContext, 'general', null, {'resourceTypes': 'user', 'q': uniqueString}, function(err, results) {
                                    ...
                                    SearchTestsUtil.searchRefreshed(janeRestContext, 'general', null, {'resourceTypes': 'user', 'q': uniqueString}, function(err, results) {
                                        ...
                                        SearchTestsUtil.searchRefreshed(camAdminRestContext, 'general', null, {'resourceTypes': 'user', 'q': uniqueString}, function(err, results) {
                                            ...
                                            SearchTestsUtil.searchRefreshed(globalAdminOnTenantRestContext, 'general', null, {'resourceTypes': 'user', 'q': uniqueString, 'scope': '_all'}, function(err, results) {
                                                assert.ok(!err);
                            ...
                            RestAPI.Group.createGroup(jackRestContext, uniqueString, uniqueString, 'public', 'no', [], [sith.id], function(err, group) {
                                ...
                                SearchTestsUtil.searchRefreshed(anonymousRestContext, 'general', null, {'resourceTypes': 'group', 'q': uniqueString}, function(err, results) {
                                    ...
                                    SearchTestsUtil.searchRefreshed(darthVaderRestContext, 'general', null, {'resourceTypes': 'group', 'q': uniqueString}, function(err, results) {
                                        ...
                                        SearchTestsUtil.searchRefreshed(darthVaderRestContext, 'general', null, {'resourceTypes': 'group', 'q': uniqueString, 'scope': '_all'}, function(err, results) {
                                            assert.ok(!err);
                                            var groupDoc = _getDocById(results, group.id);
                                            assert.ok(groupDoc);
                                            assert.equal(groupDoc.tenantAlias, group.tenant.alias);
                                                ...
                                                RestAPI.Group.createGroup(jackRestContext, uniqueStringB, uniqueStringB, 'loggedin', 'request', [], [sith.id], function(err, groupJoinable) {
                                                    ...
                                                    SearchTestsUtil.searchRefreshed(anonymousRestContext, 'general', null, {'resourceTypes': 'group', 'q': uniqueStringA}, function(err, results) {
                                                        ...
                                                        SearchTestsUtil.searchRefreshed(anonymousRestContext, 'general', null, {'resourceTypes': 'group', 'q': uniqueStringB}, function(err, results) {
                                                            ...
                                                            SearchTestsUtil.searchRefreshed(darthVaderRestContext, 'general', null, {'resourceTypes': 'group', 'q': uniqueStringA, 'scope': '_all'}, function(err, results) {
                                                                assert.ok(!err);
                                                                var groupDoc = _getDocById(results, group.id);
                                                                assert.ok(!groupDoc);

                                                                // Verify cross-tenant user can query the joinable group
                                                                SearchTestsUtil.searchRefreshed(darthVaderRestContext, 'general', null, {'resourceTypes': 'group', 'q': uniqueStringB, 'scope': '_all'}, function(err, results) {
                                                                    assert.ok(!err);
                                                                    var groupDoc = _getDocById(results, groupJoinable.id);
                                                                    assert.ok(groupDoc);
                                                                        ...
                                                                        SearchTestsUtil.searchRefreshed(janeRestContext, 'general', null, {'resourceTypes': 'group', 'q': uniqueStringA}, function(err, results) {
                                                                            ...
                                                                            SearchTestsUtil.searchRefreshed(jackRestContext, 'general', null, {'resourceTypes': 'group', 'q': uniqueStringA}, function(err, results) {
                                                                                ...
                                                                                SearchTestsUtil.searchRefreshed(lukeSkywalkerRestContext, 'general', null, {'resourceTypes': 'group', 'q': uniqueStringC}, function(err, results) {
                                                                                    ...
                                                                                    SearchTestsUtil.searchRefreshed(lukeSkywalkerRestContext, 'general', null, {'resourceTypes': 'group', 'q': uniqueStringB, 'scope': '_all'}, function(err, results) {
                                                                                        assert.ok(!err);
                                                                                        var groupDoc = _getDocById(results, groupJoinable.id);
                                                                                        assert.ok(!groupDoc);
                                                                                        ...
                                                                                        SearchTestsUtil.searchRefreshed(jackRestContext, 'general', null, {'resourceTypes': 'group', 'q': uniqueStringC, 'scope': '_all'}, function(err, results) {
                                                                                            assert.ok(!err);
                                                                                            var groupDoc = _getDocById(results, privateTenantGroup.id);
                                                                                            assert.ok(!groupDoc);
                                                                                            callback();
                                                ...
                                                RestAPI.Group.createGroup(jackRestContext, TestsUtil.generateTestUserId('groupJoinable'), 'A really super joinable group', 'private', 'request', [], [sith.id], function(err, groupJoinable) {
                                                    ...
                                                    SearchTestsUtil.searchRefreshed(anonymousRestContext, 'general', null, {'resourceTypes': 'group', 'q': 'awesome'}, function(err, results) {
                                                        ...
                                                        SearchTestsUtil.searchRefreshed(anonymousRestContext, 'general', null, {'resourceTypes': 'group', 'q': 'joinable'}, function(err, results) {
                                                            ...
                                                            // Verify cross-tenant user cannot query the unjoinable group
                                                            SearchTestsUtil.searchRefreshed(darthVaderRestContext, 'general', null, {'resourceTypes': 'group', 'q': 'awesome', 'scope': '_all'}, function(err, results) {
                                                                assert.ok(!err);
                                                                var groupDoc = _getDocById(results, group.id);
                                                                assert.ok(!groupDoc);

                                                                // Verify cross-tenant user can query the joinable group
                                                                SearchTestsUtil.searchRefreshed(darthVaderRestContext, 'general', null, {'resourceTypes': 'group', 'q': 'joinable', 'scope': '_all'}, function(err, results) {
                                                                    assert.ok(!err);
                                                                        ...
                                                                        SearchTestsUtil.searchRefreshed(janeRestContext, 'general', null, {'resourceTypes': 'group', 'q': 'awesome'}, function(err, results) {
                                                                            ...
                                                                            SearchTestsUtil.searchRefreshed(jackRestContext, 'general', null, {'resourceTypes': 'group', 'q': 'awesome'}, function(err, results) {
                                                                                ...
                                                                                SearchTestsUtil.searchRefreshed(lukeSkywalkerRestContext, 'general', null, {'resourceTypes': 'group', 'q': 'skywalker'}, function(err, results) {
                                                                                    ...
                                                                                    SearchTestsUtil.searchRefreshed(lukeSkywalkerRestContext, 'general', null, {'resourceTypes': 'group', 'q': 'joinable', 'scope': '_all'}, function(err, results) {
                                                                                        assert.ok(!err);
                                                                                        var groupDoc = _getDocById(results, groupJoinable.id);
                                                                                        assert.ok(!groupDoc);
                                                                                        ...
                                                                                        SearchTestsUtil.searchRefreshed(jackRestContext, 'general', null, {'resourceTypes': 'group', 'q': 'skywalker', 'scope': '_all'}, function(err, results) {
                                                                                            assert.ok(!err);
                                                                                            var groupDoc = _getDocById(results, privateTenantGroup.id);
                                                                                            assert.ok(!groupDoc);
