...
describe('Search API', function() {
     ...
     */
    it('verify cannot register non-unique search document producer', function(callback) {
    ...
    /**
     * Test that verifies an error is thrown when registering a search that already exists.
     */
    it('verify cannot register non-unique search', function(callback) {
     ...
     */
    it('verify cannot register non-unique reindex-all handler', function(callback) {
