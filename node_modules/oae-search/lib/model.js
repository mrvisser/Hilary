...
/**
 * A model object that represents an indexing task.
 *
 * @param  {String} 	producer 	The producer who should pick up this indexing task
 * @param  {Object} 	data 		Any data that is relevant to the indexing task
 */
module.exports.IndexTask = function(producer, data) {
	var that = {};
