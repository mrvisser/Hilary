...
/**
 * Delete the documents identified by the query
 *
 * @param  {String}    typeName        The type of document to delete
 * @param  {Object}    query           The query that identifies the documents that should be deleted
 * @param  {Function}  callback        Invoked whent he process completes
 * @param  {Object}    callback.err    An error that occurred, if any
 */
var deleteByQuery = module.exports.deleteByQuery = function(typeName, query, callback) {
    log().trace({ 'typeName': typeName, 'query': query }, 'Deleting index document by query');
    return _exec('delete', client.deleteByQuery(index, typeName, query, null), callback);
};
