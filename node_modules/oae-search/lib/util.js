...
/**
 * Given a principal resource document id and a set of principal ids, create a members document
 *
 * @param  {String}         resourceId      The ID of the parent top-level resource
 * @param  {String[]}       memberIds       The set of principal IDs who are 'members' of the top level resource
 * @return {SearchDocument}                 A document that can be indexed by ElasticSearch
 */
var createMembersDocument = module.exports.createMembersDocument = function(resourceId, memberIds) {
    return {
        '_parent': resourceId,
        '_type': SearchConstants.resourceMembersMappingName,
        'id': getResourceMembersDocumentId(resourceId),
