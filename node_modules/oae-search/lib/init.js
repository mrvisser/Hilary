...
module.exports = function(config, callback) {
    ...
    var maxConcurrentIndexers = config.search.maxConcurrentIndexers || 3;
    var destroy = config.search.index.destroyOnStartup === true;

    SearchAPI.registerSearch('general', require('./searches/general'));
    SearchAPI.refreshSearchConfiguration(index.name, { hosts: hosts }, processIndexJobs, maxConcurrentIndexers, function(err) {
        if (err) {
            return callback(err);
        }
