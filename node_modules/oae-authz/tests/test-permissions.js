...
var log = require('oae-logger').logger('authz-test');
    ...
    describe('Permissions Cache', function() {
        ...
        describe('#isAllowed()', function() {
            ...
            it('verify simple group role removal', function(callback) {
                ...
                AuthzAPI.applyGroupMembershipChanges(groupUuid, makeChange(principalUuid, 'member'), function(err) {
                    assert.ok(!err);

                    // add the 'manager' role for the group
                    AuthzAPI.applyRoleChanges(resourceUuid, makeChange(groupUuid, 'manager'), function(err) {
                        assert.ok(!err);
                        ...
                        AuthzAPI.isAllowed(principalUuid, 'manager', resourceUuid, function(err, isAllowed) {
                            ...
                            AuthzAPI.isAllowed(principalUuid, 'manager', resourceUuid, function(err, isAllowed) {
                                ...
                                AuthzAPI.applyRoleChanges(resourceUuid, makeChange(groupUuid, false), function(err) {
                                    assert.ok(!err);
            ...
            it('verify simple group membership removal', function(callback) {
                ...
                AuthzAPI.applyGroupMembershipChanges(groupUuid, makeChange(principalUuid, 'member'), function(err) {
                    ...
                    AuthzAPI.isAllowed(principalUuid, 'member', groupUuid, function(err, isAllowed) {
                        ...
                        AuthzAPI.applyGroupMembershipChanges(groupUuid, makeChange(principalUuid, false), function(err) {
                            assert.ok(!err);
                ...
                AuthzAPI.applyGroupMembershipChanges(groupUuid, makeChange(principalUuid, 'member'), function(err) {
                    ...
                    AuthzAPI.isAllowed(principalUuid, 'member', groupUuid, function(err, isAllowed) {
                        ...
                        AuthzAPI.isAllowed(principalUuid, 'manager', groupUuid, function(err, isAllowed) {
                            ...
                            AuthzAPI.applyGroupMembershipChanges(groupUuid, makeChange(principalUuid, 'manager'), function(err) {
                                assert.ok(!err);
            ...
            it('verify indirect group membership removal invalidation', function(callback) {
                ...
                AuthzAPI.applyRoleChanges(resourceUuid, makeChange(groupUuid2, 'manager'), function(err) {
                    ...
                    AuthzAPI.applyGroupMembershipChanges(groupUuid2, makeChange(groupUuid, 'member'), function(err) {
                        assert.ok(!err);
                            ...
                            AuthzAPI.isAllowed(groupUuid2, 'manager', resourceUuid, function(err, isAllowed) {
                                ...
                                AuthzAPI.isAllowed(groupUuid, 'manager', resourceUuid, function(err, isAllowed) {
                                    ...
                                    AuthzAPI.isAllowed(principalUuid, 'manager', resourceUuid, function(err, isAllowed) {
                                        ...
                                        AuthzAPI.applyGroupMembershipChanges(groupUuid2, makeChange(groupUuid, false), function(err) {
                                            assert.ok(!err);
    ...
    describe('Bloom Cache', function() {
        ...
        describe('#isAllowed()', function() {
            ...
            it('verify user role removal', function(callback) {
                ...
                var principalUuid = AuthzUtil.toUuid('u', 'b-cc-role-removal', 'mrvisser');
                var resourceUuid = AuthzUtil.toUuid('c', 'b-cc-role-removal', 'testHasRoleContent');
                ...
                AuthzAPI.applyRoleChanges(resourceUuid, makeChange(principalUuid, 'manager'), function(err) {
                    ...
                    // verify that the user has the permission. this should also make a storage entry in the cache.
                    AuthzAPI.isAllowed(principalUuid, 'manager', resourceUuid, { probablyFalse: true }, function(err, isAllowed) {
                        assert.ok(!err);
                        assert.ok(isAllowed);
            ...
            it('verify user role update', function(callback) {
                ...
                var principalUuid = AuthzUtil.toUuid('u', 'b-cc-role-update', 'mrvisser');
                var resourceUuid = AuthzUtil.toUuid('c', 'b-cc-role-update', 'testHasRoleContent');
                // add the 'manager' role
                AuthzAPI.applyRoleChanges(resourceUuid, makeChange(principalUuid, 'manager'), function(err) {
                    assert.ok(!err);
                    ...
                    AuthzAPI.isAllowed(principalUuid, 'manager', resourceUuid, { probablyFalse: true }, function(err, isAllowed) {
                        ...
                        // verify that the user does not have 'viewer'.
                        AuthzAPI.isAllowed(principalUuid, 'viewer', resourceUuid, { probablyFalse: true }, function(err, isAllowed) {
                            assert.ok(!err);
                            assert.ok(!isAllowed);
            ...
            it('verify simple group role removal', function(callback) {
                ...
                var principalUuid = AuthzUtil.toUuid('u', 'b-cc-group-role-removal', 'mrvisser');
                var groupUuid = AuthzUtil.toUuid('g', 'b-cc-group-role-removal', 'oae-team');
                var resourceUuid = AuthzUtil.toUuid('c', 'b-cc-group-role-removal', 'testHasRoleContent');
                        ...
                        AuthzAPI.isAllowed(principalUuid, 'manager', resourceUuid, { probablyFalse: true }, function(err, isAllowed) {
                            ...
                            AuthzAPI.isAllowed(principalUuid, 'manager', resourceUuid, { probablyFalse: true }, function(err, isAllowed) {
                                ...
                                AuthzAPI.applyRoleChanges(resourceUuid, makeChange(groupUuid, false), function(err) {
                                    ...
                                    AuthzAPI.isAllowed(groupUuid, 'manager', resourceUuid, { probablyFalse: true }, function(err, isAllowed) {
                                        assert.ok(!err);
            ...
            it('verify simple group role update', function(callback) {
                ...
                var principalUuid = AuthzUtil.toUuid('u', 'b-cc-group-role-update', 'mrvisser');
                var groupUuid = AuthzUtil.toUuid('g', 'b-cc-group-role-update', 'oae-team');
                var resourceUuid = AuthzUtil.toUuid('c', 'b-cc-group-role-update', 'testHasRoleContent');
            ...
            it('verify simple group membership removal', function(callback) {
                ...
                var principalUuid = AuthzUtil.toUuid('u', 'b-cc-group-membership-removal', 'mrvisser');
                var groupUuid = AuthzUtil.toUuid('g', 'b-cc-group-membership-removal', 'oae-team');

                AuthzAPI.applyGroupMembershipChanges(groupUuid, makeChange(principalUuid, 'member'), function(err) {
                    assert.ok(!err);

                    // fire up the cache entry for their membership permission
                    AuthzAPI.isAllowed(principalUuid, 'member', groupUuid, { probablyFalse: true }, function(err, isAllowed) {
                        assert.ok(!err);
                        assert.ok(isAllowed);
            ...
            it('verify simple group membership update', function(callback) {
                ...
                var principalUuid = AuthzUtil.toUuid('u', 'b-cc-group-membership-update', 'mrvisser');
                var groupUuid = AuthzUtil.toUuid('g', 'b-cc-group-membership-update', 'oae-team');
                ...
                AuthzAPI.applyGroupMembershipChanges(groupUuid, makeChange(principalUuid, 'member'), function(err) {
                    ...
                    AuthzAPI.isAllowed(principalUuid, 'member', groupUuid, { probablyFalse: true }, function(err, isAllowed) {
                        ...
                        AuthzAPI.isAllowed(principalUuid, 'manager', groupUuid, { probablyFalse: true }, function(err, isAllowed) {
                            assert.ok(!err);
                            assert.ok(!isAllowed);
            ...
            it('verify group membership removal invalidation', function(callback) {
                ...
                var principalUuid = AuthzUtil.toUuid('u', 'b-cc-group-membership-removal-invalidate', 'mrvisser');
                var groupUuid = AuthzUtil.toUuid('g', 'b-cc-group-membership-removal-invalidate', 'oae-team');
                var resourceUuid = AuthzUtil.toUuid('c', 'b-cc-group-membership-removal-invalidate', 'testHasRoleContent');
            ...
            it('verify indirect group membership removal invalidation', function(callback) {
                ...
                var principalUuid = AuthzUtil.toUuid('u', 'b-cc-indirect-group-membership-removal-invalidate', 'mrvisser');
                var groupUuid = AuthzUtil.toUuid('g', 'b-cc-indirect-group-membership-removal-invalidate', 'oae-backend-team');
                var groupUuid2 = AuthzUtil.toUuid('g', 'b-cc-indirect-group-membership-removal-invalidate', 'oae-team');
                var resourceUuid = AuthzUtil.toUuid('c', 'b-cc-indirect-group-membership-removal-invalidate', 'testHasRoleContent');
                ...
                AuthzAPI.applyRoleChanges(resourceUuid, makeChange(groupUuid2, 'manager'), function(err) {
                    ...
                    AuthzAPI.applyGroupMembershipChanges(groupUuid2, makeChange(groupUuid, 'member'), function(err) {
                        ...
                        AuthzAPI.applyGroupMembershipChanges(groupUuid, makeChange(principalUuid, 'member'), function(err) {
                            ...
                            // 2. test the setup, while heating up the cache entries
                            AuthzAPI.isAllowed(groupUuid2, 'manager', resourceUuid, { probablyFalse: true }, function(err, isAllowed) {
                                assert.ok(!err);
                                assert.ok(isAllowed);
