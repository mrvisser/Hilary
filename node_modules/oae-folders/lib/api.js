...
var _augmentFolder = function(ctx, folder, callback) {
    ...
    ContentUtil.getSignedDownloadUrls(ctx, [folder.previews.thumbnailUri, folder.previews.wideUri], null, null, function(err, thumbnailUrl, wideUrl) {
        if (err) {
            return callback(err);
        }

        _.oaeExtendDefined(folder.previews, {
