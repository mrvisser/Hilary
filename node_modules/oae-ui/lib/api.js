...
var getSkinVariables = module.exports.getSkinVariables = function(ctx, tenantAlias, callback) {
    ...
    var applyTenantValues = function(err, skinVariables) {
        ...
        _getTenantSkinVariableValues(tenantAlias, function(err, tenantVariables) {
            if (err) {
                return callback(err)
            }
...
var _generateSkin = function(tenantAlias, callback) {
    ...
    getTenantSkinVariables(tenantAlias, function(err, allVariables) {
        if (err) {
            return callback(err);
        }
 ...
 * @param  {Object}     callback.err                    An error that occurred, if any
 * @param  {Object}     callback.skinVariableValues     The CSS values keyed by the LESS variable name (without the '@')
 */
var getTenantSkinVariables = module.exports.getTenantSkinVariables = function(tenantAlias, callback) {
    ...
    _getTenantSkinVariableValues(tenantAlias, function(err, tenantVariables) {
        ...
        return callback(null, resolvedVariables);
    });
};
 ...
 * @api private
 */
var _getTenantSkinVariableValues = function(tenantAlias, callback) {
    uiConfig.getValue(tenantAlias, 'skin', 'variables', function(err, variables) {
        if (err) {
            return callback(err);
