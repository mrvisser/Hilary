...
module.exports = function() {
    ...
    strategy.shouldBeEnabled = function(tenantAlias, callback) {
        return AuthenticationConfig.getValue(tenantAlias, AuthenticationConstants.providers.FACEBOOK, 'enabled', callback);
    };
    ...
    strategy.getPassportStrategy = function(tenant, callback) {
        ...
        AuthenticationConfig.getValues(tenant.alias, AuthenticationConstants.providers.FACEBOOK, ['appid', 'secret'], function(err, authConfig) {
            if (err) {
                return callback(err);
            }
