...
module.exports = function(config, callback) {
    ...
    ensureSchema(function(err) {
        ...
        var localStrategy = require('./strategies/local/init')(config);
        ...
        var globalTenant = {'alias': config.servers.globalAdminAlias};
        localStrategy.getPassportStrategy(globalTenant, function(err, adminLocalStrategy) {
            if (err) {
                return callback(err);
            }

            var adminLocalPassportStrategyName = AuthenticationUtil.getStrategyId(globalTenant, AuthenticationConstants.providers.LOCAL);
            passport.use(adminLocalPassportStrategyName, adminLocalStrategy);
