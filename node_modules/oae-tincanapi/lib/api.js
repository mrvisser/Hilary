...
var log = require('oae-logger').logger('oae-tincanapi');
...
var _processActivities = function(activitySeed, routedActivities) {
    log().info({'activitySeed': activitySeed, 'routedActivities': routedActivities}, 'Going to process activities');
...
var sendStatementsToLRS = module.exports.sendActivitiesToLRS = function(statements, tenantAlias) {
    ...
    if (TinCanConfig.getValue(tenantAlias, 'lrs', 'enabled')) {
        ...
        log().info({'options': options}, 'Sending statements to LRS');
