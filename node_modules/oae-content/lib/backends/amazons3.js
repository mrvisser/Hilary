...
var store = module.exports.store = function(tenantAlias, file, options, callback) {
    ...
    _getBucketName(tenantAlias, function(err, bucketName) {
        if (err) {
            return callback(err);
        }
        ...
        _getClient(tenantAlias, function(err, client) {
            if (err) {
                return callback(err);
            }

            client.PutObject(options, function(err, data) {
...
var get = module.exports.get = function(tenantAlias, uri, callback) {
    ...
    _getBucketName(tenantAlias, function(err, bucketName) {
        if (err) {
            ...
            }, 'Failed to initiate the S3 client');
        ...
        _getClient(tenantAlias, function(err, client) {
            ...
            client.GetObject(options, function(err, data) {
                if (err) {
                    IO.destroyStream(writeStream);
...
var remove = module.exports.remove = function(tenantAlias, uri, callback) {
    ...
    _getBucketName(tenantAlias, function(err, bucketName) {
        ...
        _getClient(tenantAlias, function(err, client) {
            ...
            client.DeleteObject(options, function(err, data) {
                if (err) {
                    log().error({'err': err}, 'Error removing %s', uriObj.location);
                    return callback({'code': 500, 'msg': 'Unable to remove the file: ' + err});
                }
 ...
 */
var getDownloadStrategy = module.exports.getDownloadStrategy = function(tenantAlias, uri, callback) {
    ...
    _getBucketName(tenantAlias, function(err, tenantAlias) {
        if (err) {
            return callback(err);
        }

        // Construct a proper signature
        _getClient(tenantAlias, function(err, s3) {
            if (err) {
                return callback(err);
            }
            ...
            return callback(null, new DownloadStrategy(ContentConstants.backend.DOWNLOAD_STRATEGY_REDIRECT, url));
        });
    });
};
 ...
 * @param  {String}     callback.bucketName     The bucket name
 */
var _getBucketName = function(tenantAlias, callback) {
    return Config.getValue(tenantAlias, 'storage', 'amazons3-bucket', callback);
};
 ...
 * @param  {Function}   callback            Standard callback function
 * @param  {Object}     callback.err        An error that occurred, if any
 * @param  {String}     callback.client     The S3 client
 */
var _getClient = function(tenantAlias) {
    ...
    Config.getValues(tenantAlias, 'storage', keys, function(err, s3Config) {
        if (err) {
            return callback(err);
        }

        return callback(null, new S3({
