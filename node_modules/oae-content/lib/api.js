 ...
 *
 * * `createdContent(ctx, content, revision, members)`: A new content item was created. The following parameters are provided in the event:
 *      * `ctx` - The context of the use request that created the content item
 *      * `content` - The content item that was created
 *      * `revision` - The revision that represents the first revision of the content item
 *      * `members` - An object whose key is the principal ID, and the value is the role of any additional members that the content item was shared with
