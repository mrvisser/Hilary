    ...
    getContent(ctx, contentId, function(err, contentObj) {
        ...
        PrincipalsUtil.getPrincipal(ctx, contentObj.createdBy, function(err, createdBy) {
            ...
            if (!ctx.user()) {
               ...
               _canManage(ctx, contentId, { probablyFalse: true }, function(err, isManager) {
                    if (err) {
                        return callback(err);
                    }
 ...
 * @param  {Boolean}                    callback.canManage  Whether or not the user can manage the content
 */
var _canManage = function(ctx, contentId, opts, callback) {
    AuthzAPI.isAllowed(ctx.user().id, ContentConstants.roles.MANAGER, contentId, opts, callback);
};
