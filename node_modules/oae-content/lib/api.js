...
var _augmentRevision = function(ctx, revision, callback) {
    ContentUtil.getSignedDownloadUrls(ctx, [revision.thumbnailUri, revision.mediumUri], null, null, function(err, thumbnailUrl, mediumUrl) {
        if (err) {
            return callback(err);
        }

        // Update the revision object with the signed image urls
        _.oaeExtendDefined(revision, {
            'thumbnailUrl': thumbnailUrl,
            'mediumUri': mediumUrl
        });

        // Remove the image uris
