...
describe('Related content', function() {
    ...
    it('verify anonymous users can only see public content', function(callback) {
        ...
        RestAPI.Search.search(anonymousCamRestContext, 'relatedcontent', [contentItems.BY_TENANT.CAM.PUBLIC[0]], null, function(err, results) {
            ...
            RestAPI.Search.search(anonymousCamRestContext, 'relatedcontent', [contentItems.BY_TENANT.CAM.PUBLIC[0]], {'scope': '_all'}, function(err, results) {
                assert.ok(!err);
    ...
    it('verify logged in users can see both public and logged in content', function(callback) {
        ...
        RestAPI.Search.search(loggedinCamRestContexts[1], 'relatedcontent', [contentItems.BY_TENANT.CAM.PUBLIC[0]], null, function(err, results) {
            ...
            RestAPI.Search.search(loggedinCamRestContexts[1], 'relatedcontent', [contentItems.BY_TENANT.CAM.PUBLIC[0]], {'scope': '_all'}, function(err, results) {
                assert.ok(!err);
    ...
    it('verify limit handling', function(callback) {
        SearchTestsUtil.searchRefreshed(anonymousCamRestContext, 'relatedcontent', [contentItems.BY_TENANT.CAM.PUBLIC[0]], {'limit': 1, 'scope': '_all'}, function(err, data) {
            assert.ok(!err);
            ...
            SearchTestsUtil.searchRefreshed(anonymousCamRestContext, 'relatedcontent', [contentItems.BY_TENANT.CAM.PUBLIC[0]], {'limit': 2, 'scope': '_all'}, function(err, data) {
                assert.ok(!err);
                assert.equal(data.total, 7);
                ...
                SearchTestsUtil.searchRefreshed(anonymousCamRestContext, 'relatedcontent', [contentItems.BY_TENANT.CAM.PUBLIC[0]], {'limit': 'non-numeric', 'scope': '_all'}, function(err, data) {
                    assert.ok(!err);
                    assert.equal(data.total, 7);
                    assert.equal(data.results.length, 5);

                    SearchTestsUtil.searchRefreshed(anonymousCamRestContext, 'relatedcontent', [contentItems.BY_TENANT.CAM.PUBLIC[0]], {'scope': '_all'}, function(err, data) {
                        assert.ok(!err);
                        assert.equal(data.total, 7);
                        assert.equal(data.results.length, 5);
                        callback();
        ...
        TestsUtil.createTenantWithAdmin(privTenant, privTenant, function(err, privateTenant, privateTenantAdminRestCtx) {
            ...
            ConfigTestUtil.updateConfigAndWait(globalAdminRestContext, privateTenant.alias, {'oae-tenants/tenantprivacy/tenantprivate': true}, function(err) {
                ...
                RestAPI.Content.createLink(privateTenantAdminRestCtx, TITLES[0], null, 'public', 'http://www.oaeproject.org', [], [], function(err, privateContentObj) {
                    ...
                    SearchTestsUtil.searchRefreshed(loggedinCamRestContexts[1], 'relatedcontent', [contentItems.BY_TENANT.CAM.PUBLIC[0]], {'scope': '_all'}, function(err, results) {
                        assert.ok(!err);
                        ...
                        RestAPI.Search.search(privateTenantAdminRestCtx, 'relatedcontent', [contentItems.BY_TENANT.CAM.PUBLIC[0]], {'scope': '_all'}, function(err, results) {
                            assert.ok(!err);
                            var docsFromCamTenant = _.filter(results.results, function(searchDoc) { return searchDoc.tenant.alias === global.oaeTests.tenants.cam.alias; });
