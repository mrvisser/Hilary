...
var sendEmail = module.exports.sendEmail = function(templateModule, templateId, recipient, data, opts, callback) {
    ...
    TenantsConfig.getValues(recipient.tenant.alias, 'instance', ['instanceName', 'instanceURL', 'hostingOrganization', 'hostingOrganizationURL'], function(err, instanceConfigs) {
        if (err) {
            return callback(err);
        }
        ...
        var templateCtx = _.extend({}, data, {
            ...
            'shared': sharedLogic,
            'instance': {
                'name': instanceConfigs.instanceName,
                'URL': instanceConfigs.instanceUR
            },
            'hostingOrganization': {
                'name': instanceConfigs.hostingOrganization,
                'URL': instanceConfigs.hostingOrganizationUR
            }
        });
