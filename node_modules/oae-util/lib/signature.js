...
var globalSignKey = null;

/**
 * Initialize the Signature module with the global signature key
 *
...
var init = module.exports.init = function(signingConfig) {
    globalSignKey = signingConfig.key;

    if (globalSignKey === 'The default signing key, please change me.') {
...
/**
 * Sign a string for a tenant with the global signature key
 *
...
var sign = module.exports.sign = function(tenantAlias, body) {
    ...
    var hmac = Crypto.createHmac('sha1', globalSignKey);
    hmac.update(msg);
 ...
 * @return {Boolean}                    Whether or not the tenant alias and body matches the signature
 */
var verify = module.exports.verify = function(tenantAlias, body, signature) {
    return (sign(tenantAlias, body) === signature);
};
