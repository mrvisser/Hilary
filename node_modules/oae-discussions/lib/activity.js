...
ActivityAPI.registerActivityType(DiscussionsConstants.activity.ACTIVITY_DISCUSSION_UPDATE_VISIBILITY, {'routers': _updateDiscussionRouters});
...
ActivityAPI.registerActivityType(DiscussionsConstants.activity.ACTIVITY_DISCUSSION_MESSAGE, {
    ...
    'routers': {
        'activity': {
            'actor': ['self'],
            'object': ['message_contributors', 'members']
        },
        'notification': {
            'object': ['message_contributors', 'managers']
        }
    }
});
