...
var log = require('../../../oae-logger/lib/api').logger('helenus-blah');
...
Cassandra_get_result.prototype.read = function(input) {
  ...
  log().info('Cassandra_get_result.prototype.read; i=%s, time=%sms', i, Date.now() - start);
...
Cassandra_get_slice_result.prototype.read = function(input) {
  ...
  log().info('Cassandra_get_slice_result.prototype.read; i=%s, time=%sms', i, Date.now() - start);
...
Cassandra_multiget_slice_result.prototype.read = function(input) {
  ...
  log().info('Cassandra_multiget_slice_result.prototype.read; i=%s, time=%sms', i, Date.now() - start);
...
Cassandra_get_paged_slice_result.prototype.read = function(input) {
  ...
  log().info('Cassandra_get_paged_slice_result.prototype.read; i=%s, time=%sms', i, Date.now() - start);
