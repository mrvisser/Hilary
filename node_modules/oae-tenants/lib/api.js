...
var _cacheTenants = function(callback) {
    ...
    Cassandra.runQuery('SELECT * FROM "Tenant"', false, function(err, rows) {
        ...
        // Determine which tenants are interactable
        var cql = 'SELECT "tenantAlias", "value" FROM "Config" WHERE "tenantAlias" IN (?) AND "configKey" = ?';
        var params = [_.keys(tenants), 'oae-tenants/tenantprivacy/tenantprivate'];
