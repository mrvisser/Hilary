...
var _search = function(ctx, opts, callback) {
    ...
    var filter = SearchUtil.filterAnd(
        ...
        // We're searching through the list of users opts.userId is following, which means we need
        // to limit it to users who are being followed by opts.userId
        SearchUtil.createHasChildQuery('followers', SearchUtil.filterTerms('followers_ids', [opts.userId]))
    );
