...
var _search = function(ctx, opts, callback) {
    ...
    var filter = SearchUtil.filterAnd(
        ...
        // We're searching through opts.userId his followers, which means we need
        // to limit it to users who are following opts.userId
        SearchUtil.createHasChildQuery('following', SearchUtil.filterTerms('following_ids', [opts.userId]))
    );
