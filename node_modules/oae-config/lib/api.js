...
var filterModulesByConfig = function(modules, callback) {
    ...
    console.log('filterModulesByConfig');
    ...
    var doFilter = function(module) {
        fs.exists('node_modules/' + module + '/config/config.json', function(exists) {
            ...
            console.log('finished checking %s', module);
            if (exists) {
                ...
                console.log('%s === %s ?', done, modules.length);
    ...
    console.log('Modules: %s', JSON.stringify(modules));
    console.log('Modules length: %s', modules.length);

    for (var i = 0; i < modules.length; i++) {
        console.log('Filtering %s', modules[i]);
        doFilter(modules[i]);
    }
};
...
var getModules = module.exports.getModules = function(callback) {
    ...
    OAE.getAvailableModules(function(finalModules) {
        console.log('getAvailableModules.callback');
        configurableModules = {};
