...
module.exports.config = function(moduleId) {
    ...
    return {
         ...
         * @param  {Boolean|String|Number|Object}   callback.value      The requested config value e.g. `true`. This will be null if the config element cannot be found
         */
        ...
        'getValues': function(tenantAlias, featureKey, elementKeys, callback) {
            var result = _.chain(elementKeys)
                ...
                .object()
                .value();
            return callback(null, configValueInfos);
        },
