 ...
 *
 * @param  {String}     tenantAlias         The alias of the tenant for which to get the config
 * @param  {Function}   callback            Standard callback function
 * @param  {Object}     callback.err        An error that occurred, if any
 * @param  {Object}     callback.config     The media core configuration
 */
var getConfig = module.exports.getConfig = function(tenantAlias, callback) {
    MediaCoreConfig.getValues(tenantAlias, 'mediacore', ['url', 'keyId', 'secret', 'collectionId'], callback);
};
